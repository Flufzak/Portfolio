...
export const projects: Project[] = [
  ...
  },
  {
    slug: 'molt',
    title: 'MOLT',
    description: 'molt-description',
    technologies: ['Rust', 'VST3', 'OpenGL'],
    logo: '/assets/projects/molt/logo.png',
    detailLightLogo: '/assets/projects/molt/logo.svg',
    detailLightBackground: '#121214',
    usedTechnologies: [
      'Rust',
      'NIH-plug',
      'VST3',
    ...
    images: [
      {
        src: '/assets/projects/molt/molt.png',
        width: 899,
        height: 629,
        alt: 'Molt audio plugin interface',
      },
      {
        src: '/assets/projects/molt/compare.png',
        width: 1915,
        height: 1033,
        alt: 'Molt audio plugin spectrum comparison',
      },
      {
        src: '/assets/projects/molt/inaction.gif',
        width: 800,
        height: 430,
        alt: 'Molt audio plugin demonstration',
      },
    ],
  },
  {
